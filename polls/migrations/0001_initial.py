    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(max_length=255)),
                ('farmercode', models.CharField(max_length=255)),
                ('regCooperative', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Recorder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recorder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.recorder')),
                ('regCooperative', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
